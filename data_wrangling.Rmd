...
model_data <- contribution_votes %>% 
  mutate(disbursements = as.numeric(disbursements)) %>% 
...
data %>% 
  ...
  theme_classic() +
  labs(title = "Relationship Between Campaign Expenditures and Percent of Overall Vote",
       subtitle = "")
